function [hypo_alarm,carb_amount,carb_type,phase,phase_old,repeated_immediate_alarm]=m20150510_hypo_algorithm_sleep(g,g_prediction,hypo_threshold,phase_old,hypo_slope_degree,hypo_alarm_old)
