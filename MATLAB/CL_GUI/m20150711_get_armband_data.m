...
function [armband_data_with_time,ee,phys_act,sleep,gsr]=m20150711_get_armband_data(armband_data_with_time,ee,phys_act,sleep,gsr)
    [arm_data,~,arm_data_with_time]=xlsread('C:\Users\Kamuran Turksoy\Desktop\20160518_MO_CL\armband.xlsx');% reads the last downloaded armband data
    ...
    if ee(end,1)>12 % confirm physical activity with energy expenditure
        phys_act(end,1)=1;
    end
