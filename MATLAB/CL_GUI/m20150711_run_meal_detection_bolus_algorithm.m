...
if sleep(kj,1)==1 % update mu (mu is defined in our TBME paper)
    meal_gpc_mu=cat(1,meal_gpc_mu,1-0.75*max(min(0.99,gs(kj,1)/180),meal_gpc_gs_slope_degree(kj,1)/90));%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%changed
elseif phys_act(kj,1)==1
    meal_gpc_mu=cat(1,meal_gpc_mu,1-0.025*max(min(0.99,gs(kj,1)/180),meal_gpc_gs_slope_degree(kj,1)/90));
else
    meal_gpc_mu=cat(1,meal_gpc_mu,1-1*max(min(0.99,gs(kj,1)/180),meal_gpc_gs_slope_degree(kj,1)/90));%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%changed
end
