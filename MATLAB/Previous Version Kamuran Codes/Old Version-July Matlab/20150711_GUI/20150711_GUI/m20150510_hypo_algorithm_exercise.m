function [hypo_alarm,carb_amount,carb_type,phase,phase_old,repeated_immediate_alarm]=m20150510_hypo_algorithm_exercise(g,g_prediction,hypo_threshold,phase_old,hypo_slope_degree)
...
elseif 110<=g && g<130 && g_prediction<hypo_threshold && hypo_slope_degree<0
    ...
    if hypo_slope_degree<-60
        carb_amount={'8-12'};
        carb_type={'Dex4 Tablets or Juice'};
    elseif -60<=hypo_slope_degree && hypo_slope_degree<-30
        carb_amount={'8'};
        carb_type={'Crackers'};
    elseif -30<=hypo_slope_degree && hypo_slope_degree<0
