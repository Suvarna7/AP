...
function [armband_data_with_time,ee,phys_act,sleep,gsr]=m20150711_get_armband_data(armband_data_with_time,ee,phys_act,sleep,gsr)
   % [arm_data,~,arm_data_with_time]=xlsread('C:\Users\Ali Cinar\Desktop\data\8.20.2014 openloop  JDRF5\JDRF5_2014_08_20.xls');% reads the last downloaded armband data
    [arm_data,~,arm_data_with_time]=xlsread('D:\Phd\Research\Kamuran`s Code\Matlab\JDRF17_04222015 TO 04272015_ARMBAND.xls');
