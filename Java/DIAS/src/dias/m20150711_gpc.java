...
public class m20150711_gpc {
  ...
  //   phi_gsr=phi_gsr.transpose();
     phi_gsr_trans=phi_gsr.transpose();
        ...
        opt_recursive opt_r = new opt_recursive ((gs.get(0,kj-1)),phitemp,armax_parameterstemp,armax_covariancetemp,(armax_lamda.get(kj-1,0)),upperlim,lowerlim);
       ...
       /////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        A_state[1][0][kj]=1;  A_state[2][1][kj]=1;  A_state[4][3][kj]=1;
        A_state[5][4][kj]=1;  A_state[6][5][kj]=1;  A_state[7][6][kj]=1;
        A_state[8][7][kj]=1;  A_state[9][8][kj]=1;  A_state[10][9][kj]=1;
        A_state[11][10][kj]=1; A_state[12][11][kj]=1;  A_state[13][12][kj]=1;
        A_state[15][14][kj]=1;   A_state[16][15][kj]=1;  A_state[18][17][kj]=1;  A_state[19][18][kj]=1;
        ...
        A_state_ee[1][0][kj]=1;    A_state_ee[2][1][kj]=1;
        ...
        A_state_gsr[1][0][kj]=1;   A_state_gsr[2][1][kj]=1;
       ...
       lgvariables.C_state_gsr=C_state_gsr;
        ...
        B_state[0][0][kj]=B1.get(0,0);   B_state[0][1][kj]=B2.get(0,0);  B_state[0][2][kj]=B3.get(0,0);
        
        for(int i=1; i<3;i++)
            for(int j=0; j<2;j++)
                B_state[i][j][kj]=0;

        B_state[3][0][kj]=1; B_state[3][1][kj]=0;  B_state[3][2][kj]=0;
        
             for(int i=4; i<14;i++)
                 for(int j=0; j<2;j++)
                      B_state[i][j][kj]=0;
             
        B_state[14][0][kj]=0; B_state[14][1][kj]=1; B_state[14][2][kj]=0;    
        
         for(int i=15; i<17;i++)
                 for(int j=0; j<2;j++)
                      B_state[i][j][kj]=0;
              
        B_state[17][0][kj]=0;  B_state[17][1][kj]=0; B_state[17][2][kj]=1;   
       ...
       lgvariables.B_state=B_state;
          ...
          K_state[0][0][kj]=1;    K_state[20][0][kj]=1;
          K_state_ee[0][0][kj]=1;   K_state_ee[1][0][kj]=0; K_state_ee[2][0][kj]=0;  K_state_ee[3][0][kj]=1;
          K_state_gsr[0][0][kj]=1;   K_state_gsr[1][0][kj]=0; K_state_gsr[2][0][kj]=0;  K_state_gsr[3][0][kj]=1;
       ...
       lgvariables.K_state_gsr=K_state_gsr;
         ...
         lgvariables.M_ee= createnew3Dmatrix (lgvariables.M_ee,p_hor.M.getRowDimension(),p_hor.M.getColumnDimension(),kj+1);
          ...
          X_state.set(4,kj,phi.get(5, kj)); X_state.set(5,kj,phi.get(6, kj)); X_state.set(6,kj,phi.get(7, kj)); X_state.set(7,kj,phi.get(8, kj)); X_state.set(8,kj,phi.get(9, kj));
          X_state.set(9,kj,phi.get(10, kj)); X_state.set(10,kj,phi.get(11, kj)); X_state.set(11,kj,phi.get(12, kj)); X_state.set(12,kj,phi.get(13, kj)); X_state.set(13,kj,phi.get(14, kj));// X_state.set(14,kj-1,phi.get(15, kj)); X_state.set(15,kj-1,phi.get(16, kj));
          
          X_state.set(14,kj,phi.get(16, kj));  X_state.set(15,kj,phi.get(17, kj)); X_state.set(16,kj,phi.get(18, kj));
          
          X_state.set(17,kj,phi.get(20, kj)); X_state.set(18,kj,phi.get(21, kj)); X_state.set(19,kj,phi.get(22, kj)); X_state.set(20,kj,phi.get(23, kj));
