 ...
 * @author User
 */
public class hypo_algorithm_sleep {
    ...
    public hypo_algorithm_sleep(double g,double g_prediction,double hypo_threshold,double phase_old,double hypo_slope_degree){
      this.g=g;
    ...
    public void m20150510_hypo_algorithm_sleep(){
