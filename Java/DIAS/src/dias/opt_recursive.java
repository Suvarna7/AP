...
public class opt_recursive {
    ...
    public void runOptimization() {
        ...
        pP = P.inverse();
        /*if (P.det() != 0) {
            //Inverse returns the inverse of the matrix if it is square
            ...
            for (int i = 0; i < P.getColumnDimension(); i++) {
                for (int j = 0; j < P.getRowDimension(); j++) {
                    //When the matrix is square: pP = P^-1
                    //pP.set(i, j, 1 / P.get(i, j) / (P.getColumnDimension() + P.getRowDimension()));
                                pP = P.inverse();
                }
            }
        }*/
        ...
        calcfc = (int n, int m, double[] Q, double[] con) -> {
            ...
            //Actually.... we should use the constraings, con, to perform the constraints:
