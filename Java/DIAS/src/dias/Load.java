...
public class Load {
    ...
    public Matrix load(Matrix matrix, String filename) throws FileNotFoundException, IOException {
    ...
    public double[][][] load3D(double[][][] matrix3d, String filename, int kj) throws FileNotFoundException, IOException {
        Matrix matrice = new Matrix(matrix3d.length, matrix3d[0].length);
        ...
        for (int t = 0; t < kj; t++) {
            ...
            matrix3D = new double[matrice.getRowDimension()][matrice.getColumnDimension()][kj];
