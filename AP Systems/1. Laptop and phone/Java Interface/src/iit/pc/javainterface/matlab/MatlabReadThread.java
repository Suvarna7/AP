			...
			try {
				...
				if (line != null){
					...
					if (line.equals(MatlabSocket._READ_LAST_SAMPLES)){
						...
						matlabHost.mBridge.gui.updateUSBConnectionStatus("Request messages", "..................");
					...
					//Send ACK message back to phone
						...
						//Send ack to phone
						matlabHost.mBridge.gui.updateUSBConnectionStatus("Messages processed: Sending ACKs", ".....................");
					...
					//Check USB connection
						...
						if (matlabHost.mBridge.mHost.isConnected()){
							matlabHost.sendMessageToMatlab(matlabHost._USB_CONNECTED);
							//Update GUI
							//TODO Now we can update the GUI
							matlabHost.mBridge.gui.usbConnectButton.setText("CONNECTED");
							matlabHost.mBridge.gui.usbConnectButton.setEnabled(false);
							matlabHost.mBridge.gui.usbConnectButton.setBackground(Color.GREEN);
						}else{
							matlabHost.sendMessageToMatlab(matlabHost._USB_DISCONNECTED);
							//Update GUI
							matlabHost.mBridge.gui.usbConnectButton.setText("USB Connect");
							matlabHost.mBridge.gui.usbConnectButton.setEnabled(true);
							matlabHost.mBridge.gui.usbConnectButton.setBackground(BMGuiProgram.DULL_BUTTON_COLOR);
