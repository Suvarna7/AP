...
public class controller_ins {
    ...
    public double rhoend = 1.0e-8;
    public int iprint = 0;
    public int maxfun = 3500;
    ...
    public controller_ins (Matrix g_prediction, Matrix L, Matrix bolus_insulin, Matrix basal_insulin ,double minumum_basal, Matrix reference_glucose,int Nu,int st,double body_weight, Matrix insulin_sensitivity_constant,int flag_constrains ){
