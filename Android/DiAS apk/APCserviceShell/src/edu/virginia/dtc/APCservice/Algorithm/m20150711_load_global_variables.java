...
import Jama.Matrix;
import edu.virginia.dtc.APCservice.Subject;
...
public class m20150711_load_global_variables {
	...
	public static  Matrix gs  =new Matrix (1,1);
	public static int kj=21 ;
	///////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	public void m20150711_load_global_variables(){
		...
		// body_weight=0;  //We dont need to arrange it
		////////////////////////Before Experiment//////////////////////////////////////////////
		gs_in=175;    //////////////***** We use height as a gs_in
		ee_in=0.2;
		gsr_in=0.139;
		sleep_in=0;
		phys_act_in=0;
