...
public class MCMservice extends Service
{
    ...
    //Content Observer
  	...
  	//Send insulin to IIT
	//private String INSULIN_TABLE_NAME = "bolus_table_insulin";
  	private String INSULIN_TABLE_NAME = "sample_table_insulin";
	private final String IIT_SERVER_URL = "http://216.47.158.133/mysqlSync/insert_into_table.php";
	private final String IIT_SERVER_READ_TABLE = "http://216.47.158.133/mysqlSync/read_table_values.php";
	private final String JSON_ID = "diasJSON";
            ...
            switch (msg.what) 
            {
	            ...
	            case Meal.INJECT:
					...
					double insulin_inj = (double)meal + (double)correction;
	     			iTable.put("total_units_insulin",""+insulin_inj);
	     			iTable.put("amount_commanded",""+insulin_inj);
	     			iTable.put("command_num",""+101);
	     			//Table name and time
					...
					//Debug.i(TAG, FUNC_TAG, "Values from bolus meal:" + IITServerConnector.convertToJSON(dArgs));
