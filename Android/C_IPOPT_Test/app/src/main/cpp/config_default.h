...
//XXX DEBUG : I'm not sure where the configall_system.h is supposed to come from, but I removed this include statement.
...
/***************************************************************************/
// XXX DEBUG : This is just for my own sanity. If this warning comes up, it means what it says.
#warning "You are using the config_default.h configuration rather than the config.h configuration."
