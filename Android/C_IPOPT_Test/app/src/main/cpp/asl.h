...
/* This is a currently unmodified version of asl.h from http://www.ampl.com/netlib/ampl/solvers/asl.h . 
I've added it to this directory because it doesn't appear to be part of Android's standard library, and the file AmplTNLP.cpp 
requires it. - ZM */

#ifndef ASL_included
#define ASL_included

// XXX DEBUG : I'm removed the reference to arith.h, since it just seems to be architecture-specific defines.
