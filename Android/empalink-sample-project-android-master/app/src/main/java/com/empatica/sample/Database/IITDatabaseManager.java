...
public class IITDatabaseManager {
    ...
    private static int ONE_SECOND_DATA = (64+32+4+4+1);
    public static int MAX_READ_SAMPLES_UPDATE = 30*60* ONE_SECOND_DATA;

    //1 second = 64 + 32 + 4 + 4 + 1 = 105 samples
    //Sending up to 10 minutes
    public static int MAX_READ_SAMPLES_SYNCHRONIZE = 4*60* ONE_SECOND_DATA;
